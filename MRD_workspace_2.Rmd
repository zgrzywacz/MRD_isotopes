...
```{r}
c13_atm$corrected <- (c13_atm$C13 + 6.61)
carbon_for_correction <- tab2[1:56,]
split_annual_c13 <- c13_atm[111:166,]
new_c13 <- carbon_for_correction - split_annual_c13$corrected
new_c13
```
...
```{r}
cor.test(c13_summary, std_summary[1:56])
```
